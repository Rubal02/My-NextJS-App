import svgPaths from "@/lib/svg/svg4";
...
function Frame7({ text }: { text: string }) {
  return (
...
function Frame4({ title, description }: { title: string; description: string }) {
  return (
...
function Frame8({ content }: { content: Content }) {
  return (
